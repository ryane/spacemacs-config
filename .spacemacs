...
values."
  (setq-default
   ...
   '(
     ...
     yaml
     javascript
     (go :variables go-tab-width 2 go-use-golangci-lint t)
     terraform
     docker
     react
     vinegar
